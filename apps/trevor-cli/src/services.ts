...
/**
 * The reserved loopback ports the shared services bind (the source of truth is `~/.agents/PORTS.md`).
 * These are checked, never re-assigned - a port held by something else is a reported conflict.
 */
