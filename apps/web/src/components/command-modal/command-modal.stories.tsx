...
const worktreeRows: CommandRow[] = [
  {
    id: "baseline",
    label: "main",
    metadata: "~/dev/trevor · baseline checkout",
    status: "clean",
    statusTone: "muted",
    current: true,
    group: "trevor",
  ...
  },
  {
    ...
    metadata: ".worktrees/trevor/feat-sidebar-git-a1b2",
    status: "2 agents",
    statusTone: "active",
    group: "trevor",
  },
  {
    ...
    metadata: ".worktrees/trevor/feat-explicit-resume-c3d4",
    status: "needs you",
  ...
  },
  {
    ...
    metadata: ".worktrees/trevor/fix-flaky-test-e5f6",
    status: "idle",
    statusTone: "muted",
    group: "trevor",
  },
  {
    id: "wt-dirty",
    label: "chore/deps",
    metadata: ".worktrees/trevor/chore-deps-7788",
    status: "dirty ↑3 ↓1",
    statusTone: "attention",
    group: "trevor",
  },
  {
    ...
    metadata: ".worktrees/trevor/feat-merge-back-9900",
...
const resumeRows: CommandRow[] = [
  {
    ...
    metadata: "~/dev/trevor · feat/sidebar-git · 412 events",
    status: "running",
    statusTone: "active",
    current: true,
  ...
  },
  {
    ...
    metadata: "~/dev/trevor · main · 88 events · 2h ago",
    status: "host ready",
    statusTone: "success",
    group: "Current project",
  },
  {
    ...
    metadata: "~/dev/trevor · main · 12 events · 1d ago",
    status: "queued",
    statusTone: "attention",
    group: "Current project",
  },
...
export const ManyRows: Story = {
  args: {
    ...
    rows: Array.from({ length: 40 }, (_, i) => ({
      id: `wt-${i}`,
      label: `feat/branch-${i}`,
      metadata: `.worktrees/trevor/feat-branch-${i}-${i.toString(16)}`,
    ...
    rows: [
      {
        ...
        metadata:
          ".worktrees/trevor/feature-extremely-long-branch-name-that-keeps-going-well-past-the-modal-width-abcd",
        status: "dirty ↑12 ↓7",
        statusTone: "attention",
        group: "trevor",
      },
