...
const worktreeRows: CommandRow[] = [
  {
    id: "baseline",
    label: "main",
    metadata: "~/dev/trevorV2 · baseline checkout",
    status: "clean",
    statusTone: "muted",
    current: true,
    group: "trevorV2",
  ...
  },
  {
    ...
    metadata: ".worktrees/trevorV2/feat-sidebar-git-a1b2",
    status: "2 agents",
    statusTone: "active",
    group: "trevorV2",
  },
  {
    ...
    metadata: ".worktrees/trevorV2/feat-explicit-resume-c3d4",
    status: "needs you",
  ...
  },
  {
    ...
    metadata: ".worktrees/trevorV2/fix-flaky-test-e5f6",
    status: "idle",
    statusTone: "muted",
    group: "trevorV2",
  },
  {
    id: "wt-dirty",
    label: "chore/deps",
    metadata: ".worktrees/trevorV2/chore-deps-7788",
    status: "dirty ↑3 ↓1",
    statusTone: "attention",
    group: "trevorV2",
  },
  {
    ...
    metadata: ".worktrees/trevorV2/feat-merge-back-9900",
...
const resumeRows: CommandRow[] = [
  {
    ...
    metadata: "~/dev/trevorV2 · feat/sidebar-git · 412 events",
    status: "running",
    statusTone: "active",
    current: true,
  ...
  },
  {
    ...
    metadata: "~/dev/trevorV2 · main · 88 events · 2h ago",
    status: "host ready",
    statusTone: "success",
    group: "Current project",
  },
  {
    ...
    metadata: "~/dev/trevorV2 · main · 12 events · 1d ago",
    status: "queued",
    statusTone: "attention",
    group: "Current project",
  },
...
export const ManyRows: Story = {
  args: {
    ...
    rows: Array.from({ length: 40 }, (_, i) => ({
      id: `wt-${i}`,
      label: `feat/branch-${i}`,
      metadata: `.worktrees/trevorV2/feat-branch-${i}-${i.toString(16)}`,
    ...
    rows: [
      {
        ...
        metadata:
          ".worktrees/trevorV2/feature-extremely-long-branch-name-that-keeps-going-well-past-the-modal-width-abcd",
        status: "dirty ↑12 ↓7",
        statusTone: "attention",
        group: "trevorV2",
      },
