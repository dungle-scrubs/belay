    ...
    return (
      <div
        ...
        className={cn(
          ...
          "bg-[linear-gradient(to_bottom,var(--trevor-reasoning-fade-bg,var(--color-background)),transparent)]",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-[linear-gradient(to_top,var(--trevor-reasoning-fade-bg,var(--color-background)),transparent)]",
