...
// `@belay/agent-host/testing/lsp-fixtures` export (the mcp-fixtures precedent, plan 24 M9).
// Strictly side-effect-free (node builtins only), so cross-service e2e can import it STATICALLY
// and lay the workspace on disk BEFORE BELAY_WORKSPACE binds and any host module loads.
export {
  createEvalWorkspace,
