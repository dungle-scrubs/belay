...
// `@trevor/agent-host/testing/mcp-fixtures` export (plan 23 M9). A SEPARATE entry from
...
// heavy testing surface - whose host singletons read `<TREVOR_HOME>/mcp-servers.json` at
