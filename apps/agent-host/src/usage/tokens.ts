 ...
 * breakdown display (usage/breakdown.ts) and compaction budgeting (agent/compactor.ts). Kept in
 * ONE place so the estimate and its rounding can never drift between
