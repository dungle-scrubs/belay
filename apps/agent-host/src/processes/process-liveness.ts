 ...
 *
 * (Distinct from the launcher's `apps/belay-cli/src/platform.ts` variant, which treats EPERM as not-
 ...
 * Not for: the launcher's not-ours/dead EPERM variant - apps/belay-cli/src/platform.ts.
 */
