...
- [ ] `24-vim-motions-ui` complete or coordinated before shortcut routing implementation
- [ ] `03-filesystem-root-taxonomy` complete before config-editing Vim toggle implementation
- [x] `18-nested-command-menu` exists as command-like UI foundation
...
- [ ] REFACTOR: Keep config read/write logic shared with `24-vim-motions-ui`
