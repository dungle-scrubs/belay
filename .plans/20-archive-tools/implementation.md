...
- `34-transcript-image-rendering` and future video inspection own rich media display; archive tools may produce artifact refs and metadata that those surfaces can render.
...
- **Dependencies:** M8, `08-tool-detail-takeover`
- **Effort:** M
- **Tasks:**
