...
- [x] `.plans/04-archive-browser-and-delete` owns archive browser and permanent delete.
- [x] `.plans/01-managed-worktree-hardening` owns remaining D-091 hardening.
...
Canonical decisions are in `.plans/44-session-manager-residual/plan.db`.
