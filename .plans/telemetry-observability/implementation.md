...
```bash
mise x node@22 -- npx tsx /Users/kevin/dev/dotfiles/agents/.agents/skills/planner/scripts/plan-db.ts check-progress --plan "telemetry-observability"
```
...
Canonical decisions are recorded in `.plans/telemetry-observability/plan.db`.
