...
```bash
mise x node@22 -- npx tsx /Users/kevin/dev/dotfiles/agents/.agents/skills/planner/scripts/plan-db.ts check-progress --plan "47-bounded-child-takeover"
```
...
Canonical decisions are in `.plans/47-bounded-child-takeover/plan.db`.
