...
- `20-archive-tools` owns archive validation and archive entry dispatch. It can call or share the video processor, but it does not own direct `video_inspect` provider-loop semantics.
- `34-transcript-image-rendering` owns reusable image rendering for frame artifacts in transcript/detail surfaces.
...
- **Dependencies:** M4, `20-archive-tools`
- **Effort:** M
- **Tasks:**
...
- **Dependencies:** M4, `08-tool-detail-takeover`, `34-transcript-image-rendering`
- **Effort:** M
- **Tasks:**
