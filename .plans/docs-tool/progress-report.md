...
- [x] `web-fetch-tool` complete before implementation starts
- [x] `filesystem-root-taxonomy` complete before implementation starts
...
- [ ] RED: Add storage tests proving the selected root comes from `filesystem-root-taxonomy`.
