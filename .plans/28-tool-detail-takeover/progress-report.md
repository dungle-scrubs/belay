...
- [ ] `25-keyboard-shortcuts` - focus guards and Escape ownership.
- [ ] `27-compact-transcript-layout` - compact row/detail eligibility language.
- [x] Existing model chooser transcript-takeover pattern from D-065.
- [x] Existing archive-browser plan pattern in `.plans/26-archive-browser-and-delete`.
