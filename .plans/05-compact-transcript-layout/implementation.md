...
The progress report is `.plans/05-compact-transcript-layout/progress-report.md`. It tracks only compact transcript display mode and its Storybook/live toggle. It does not track transcript data compaction, prompt-history compaction, model context reduction, or tool-detail takeover.
...
Canonical decisions are in `.plans/05-compact-transcript-layout/plan.db`.
